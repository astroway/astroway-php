...
/** Service for localSpace.* endpoints. */
final class LocalSpaceService
{
    ...
    public function compute(array|object|null $body = null, array $options = []): mixed
    {
        ...
        return $this->client->request('POST', '/local-space', $opts);
    }
     ...
     * @param array{headers?: array<string, string>, query?: array<string, scalar|array<int|string, scalar>>, idempotencyKey?: string} $options
     */
    public function influenceZone(array|object|null $body = null, array $options = []): mixed
    {
        $opts = [];
        if ($body !== null) {
            $opts['json'] = $body;
        ...
        return $this->client->request('POST', '/local-space/influence-zone', $opts);
    }
}
