...
/** Service for rectification.* endpoints. */
final class RectificationService
{
    ...
    public function compute(array|object|null $body = null, array $options = []): mixed
    {
        ...
        return $this->client->request('POST', '/rectification', $opts);
    }
     ...
     * @param array{headers?: array<string, string>, query?: array<string, scalar|array<int|string, scalar>>, idempotencyKey?: string} $options
     */
    public function trutine(array|object|null $body = null, array $options = []): mixed
    {
        $opts = [];
        if ($body !== null) {
            $opts['json'] = $body;
        ...
        return $this->client->request('POST', '/rectification/trutine', $opts);
    }
}
